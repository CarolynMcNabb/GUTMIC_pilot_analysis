...
fsleyes $FSLDIR/data/standard/MNI152_T1_1mm ${stats_path}/mean_FA_skeleton --cmap green --displayRange 0.2 0.8 ${stats_path}/shannon_tfce_corrp_tstat1.nii.gz --cmap red-yellow --displayRange 0.95 1 &
...
#visualise output and print the maximum value in a file called inferential_stats.txt
fsleyes $FSLDIR/data/standard/MNI152_T1_1mm ${stats_path}/mean_FA_skeleton --cmap green --displayRange 0.2 0.8 ${stats_path}/otus_tfce_corrp_tstat1.nii.gz --cmap red-yellow --displayRange 0.95 1 &
...
#visualise output and print the maximum value in a file called inferential_stats.txt
fsleyes $FSLDIR/data/standard/MNI152_T1_1mm ${stats_path}/mean_FA_skeleton --cmap green --displayRange 0.2 0.8 ${stats_path}/faith_tfce_corrp_tstat1.nii.gz --cmap red-yellow --displayRange 0.95 1 &
