...
#4.4_eddy.sh will correct eddy current-induced distortions and subject movements using FSL's eddy_openmp and store output in derivatives/TBSS/preprocessed folder for that ppt
