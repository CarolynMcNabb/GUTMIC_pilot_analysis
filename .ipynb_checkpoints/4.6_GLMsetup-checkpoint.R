...
#read in demographic and gut diversity data
pilot_raw <- read.csv("pilot_bacteria_mrs_lcms_GenusLevel.csv")
diversity <- pilot_raw[c("age","hand","faith_pd","shannon","observed_otus")]
...
#create dataframes for GLM, including diversity measures, age, handedness and motion, then demean these values for use in FSL's randomise
